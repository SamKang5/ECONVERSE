    ...
    lessons: [
      {
        ...
        mainContentTitle: "Cung và cầu là gì?",
        mainContent: [
          "Cung và cầu là hai lực cơ bản quyết định giá của hầu hết hàng hóa và dịch vụ trong đời sống. Cầu thể hiện số lượng người muốn mua một món đồ và thực sự có khả năng trả tiền cho món đồ đó. Cung thể hiện số lượng hàng hóa mà người bán sẵn sàng và có thể đưa ra thị trường trong cùng một khoảng thời gian.",
          "Khi cầu tăng nhanh hơn cung, người mua phải cạnh tranh với nhau để sở hữu món hàng, nên giá thường bị đẩy lên. Đây là lý do những món đang hot, vé sự kiện hiếm hoặc món ăn theo trend thường tăng giá rất mạnh trong thời gian ngắn. Ngược lại, nếu người bán có quá nhiều hàng nhưng người mua không còn hứng thú, họ sẽ phải giảm giá để bán được hàng.",
          "Thị trường thường dịch chuyển đến một mức giá cân bằng, nơi lượng người muốn mua gần khớp với lượng người sẵn sàng bán. Hiểu được cung và cầu giúp bạn đọc được vì sao giá thay đổi, thay vì chỉ cảm thấy mọi thứ bỗng nhiên đắt lên hoặc rẻ đi. Đây là nền tảng quan trọng để giải thích từ giá trà sữa, giá xăng cho đến giá nhà."
        ],
        summary: {
      ...
      },
      {
        ...
        mainContentTitle: "Lạm phát là gì?",
        mainContent: [
          "Lạm phát là hiện tượng mức giá chung tăng lên theo thời gian, khiến cùng một số tiền mua được ít hàng hóa và dịch vụ hơn trước. Nói cách khác, tiền không tự biến mất khỏi ví của bạn, nhưng sức mua của nó yếu đi nên bạn phải chi nhiều hơn cho cùng một nhu cầu.",
          "Lạm phát có thể xuất phát từ phía chi phí, chẳng hạn giá xăng, nguyên liệu, tiền thuê hoặc lương tăng, khiến doanh nghiệp buộc phải nâng giá bán để bù đắp. Nó cũng có thể đến từ phía cầu, khi quá nhiều người cùng muốn mua hàng trong lúc lượng hàng trên thị trường không tăng kịp.",
          "Một mức lạm phát vừa phải thường đi cùng tăng trưởng kinh tế, nhưng lạm phát cao kéo dài sẽ làm người đi làm, người tiết kiệm và người có thu nhập cố định chịu áp lực lớn nhất. Hiểu lạm phát giúp bạn lý giải vì sao cần quản lý chi tiêu, tiết kiệm sớm và quan sát giá cả bằng sức mua thực tế chứ không chỉ bằng con số trên tờ tiền."
        ],
        summary: {
    ...
    lessons: [
      {
        ...
        mainContentTitle: "Quy tắc 50/30/20 hoạt động ra sao?",
        mainContent: [
          "Quy tắc 50/30/20 là một cách chia tiền đơn giản để bạn không tiêu hết sạch trước khi tháng kết thúc. Ý tưởng cốt lõi là chia thu nhập thành ba nhóm rõ ràng: phần dành cho nhu cầu thiết yếu, phần dành cho sở thích cá nhân và phần bắt buộc phải giữ lại cho tiết kiệm hoặc đầu tư.",
          "Khoảng 50% ngân sách nên dành cho những khoản khó cắt bỏ như ăn uống cơ bản, đi lại, học tập hoặc các chi phí sinh hoạt bắt buộc. Khoảng 30% còn lại là không gian cho niềm vui như giải trí, mua sắm nhỏ, trà sữa hay những thứ giúp cuộc sống bớt căng. 20% cuối cùng là phần quan trọng nhất vì đây là khoản giúp bạn tạo quỹ dự phòng và bớt bị động khi có việc bất ngờ.",
          "Điểm mạnh của quy tắc này là nó giúp bạn nhìn tiền theo mục đích thay vì tiêu theo cảm xúc. Khi biết rõ mỗi đồng thuộc nhóm nào, bạn sẽ dễ tự kiểm soát hơn, ít rơi vào cảnh cuối tháng cạn ví và dần xây được thói quen tích lũy bền vững."
        ],
        summary: {
      ...
      },
      {
        ...
        mainContentTitle: "Lãi kép là gì và vì sao nên bắt đầu sớm?",
        mainContent: [
          "Lãi kép là cơ chế mà tiền lãi sau mỗi kỳ không bị tách riêng, mà được nhập ngược trở lại vào vốn ban đầu để tiếp tục sinh thêm lãi. Vì vậy, ở kỳ sau bạn không chỉ kiếm tiền từ số vốn gốc, mà còn kiếm tiền từ chính phần lãi đã tích lũy trước đó.",
          "Trong giai đoạn đầu, tốc độ tăng trưởng của lãi kép có thể trông khá chậm nên nhiều người dễ nản. Nhưng càng về sau, khi số vốn tích lũy lớn dần, phần lãi sinh ra cũng lớn hơn và tạo cảm giác tăng tốc rất mạnh. Đó là lý do người bắt đầu sớm thường có lợi thế lớn hơn người đầu tư muộn, ngay cả khi mỗi tháng chỉ góp một khoản nhỏ.",
          "Bài học quan trọng nhất của lãi kép không phải là kiếm lời thật nhanh, mà là kiên trì đủ lâu để thời gian làm việc thay bạn. Càng giữ được thói quen tiết kiệm và tái đầu tư đều đặn, bạn càng tận dụng tốt sức mạnh của tăng trưởng theo cấp số nhân."
        ],
        summary: {
